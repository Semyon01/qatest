...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page,identifier: str):
        ...
        self.create_course_title_input = page.get_by_test_id(f'{identifier}-title-input').locator('input')
        ...
        self.create_course_max_score_input = page.get_by_test_id(f'{identifier}-max-score-input').locator('input')
        self.create_course_min_score_input = page.get_by_test_id(f'{identifier}-min-score-input').locator('input')
