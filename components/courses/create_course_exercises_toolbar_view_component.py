...
class CreateCourseExercisesToolbarViewComponent(BaseComponent):
    def __init__(self, page: Page,identifier: str):
        ...
        self.exercises_title = page.get_by_test_id(f'{identifier}-box-toolbar-title-text')
        self.create_exercise_button = page.get_by_test_id(f'{identifier}-box-toolbar-create-exercise-button')
