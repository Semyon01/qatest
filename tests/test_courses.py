...
def test_create_course(chromium_page_with_state: Page, create_course_page: CreateCoursePage,courses_list_page: CoursesListPage):
    ...
    create_course_page.exercises_toolbar_view.check_visible_exercises_title()
    create_course_page.exercises_toolbar_view.check_visible_create_exercise_button()
    create_course_page.check_visible_exercises_empty_view()
    create_course_page.image_upload_widget.upload_preview_image(file='C:\\Users\\semyo\\PycharmProjects\\PythonProjectPW\\test_data\\files\\image.png')
